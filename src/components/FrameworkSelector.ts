...
export class FrameworkSelector {
  ...
  private updateBtnTitle(): void {
    ...
    this.btn.title = fw ? `Framework: ${fw.name}` : t('components.insights.analysisFrameworksLabel');
  }
  ...
  private openPopup(): void {
    ...
    label.textContent = t('components.insights.analysisFrameworksLabel');
  ...
  private populateOptions(select: HTMLSelectElement): void {
    ...
    defaultOpt.value = '';
    defaultOpt.textContent = t('components.insights.analysisFrameworksDefaultNeutral');
