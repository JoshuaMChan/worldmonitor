...
import { applyZhPanelTitleGlossary } from '@/utils/localized-fallback-titles';
...
export class PanelLayoutManager implements AppModule {
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        return `
          ...
          ${cleanMode ? '' : `<a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@eliehabib</span>
          </a>`}
          ${cleanMode ? '' : `<a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">${t('header.worldMonitor')}</span>
        ...
        <div class="mobile-menu-footer-links">
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">${t('header.pro')}</a>`}
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/blog/' : 'https://www.worldmonitor.app/blog/'}" target="_blank" rel="noopener">${t('header.blog')}</a>`}
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/docs' : 'https://www.worldmonitor.app/docs'}" target="_blank" rel="noopener">${t('header.docs')}</a>`}
          <a href="https://status.worldmonitor.app/" target="_blank" rel="noopener">${t('header.status')}</a>
        </div>
      ...
      ${cleanMode ? '' : `<footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">${t('header.worldMonitor')}</span>
        ...
        <nav>
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">${t('header.pro')}</a>
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/blog/' : 'https://www.worldmonitor.app/blog/'}" target="_blank" rel="noopener">${t('header.blog')}</a>
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/docs' : 'https://www.worldmonitor.app/docs'}" target="_blank" rel="noopener">${t('header.docs')}</a>
          <a href="https://status.worldmonitor.app/" target="_blank" rel="noopener">${t('header.status')}</a>
          <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener">${t('header.github')}</a>
          <a href="https://discord.gg/re63kWKxaz" target="_blank" rel="noopener">${t('header.discord')}</a>
          <a href="https://x.com/worldmonitorai" target="_blank" rel="noopener">${t('header.x')}</a>
  ...
  getLocalizedPanelName(panelKey: string, fallback: string): string {
    ...
    return applyZhPanelTitleGlossary(fallback);
  }
