    ...
    this.ctx.container.innerHTML = `
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">Pro</a>`}
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/blog/' : 'https://www.worldmonitor.app/blog/'}" target="_blank" rel="noopener">Blog</a>`}
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/docs' : 'https://www.worldmonitor.app/docs'}" target="_blank" rel="noopener">Docs</a>`}
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            ...
            <span class="site-footer-sub">v${__APP_VERSION__}${cleanMode ? '' : ` &middot; <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="site-footer-credit">@eliehabib</a>`}</span>
          </div>
        </div>
        <nav>
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/pro' : 'https://www.worldmonitor.app/pro'}" target="_blank" rel="noopener">Pro</a>`}
          ...
          ${cleanMode ? '' : `<a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/docs' : 'https://www.worldmonitor.app/docs'}" target="_blank" rel="noopener">Docs</a>`}
          <a href="https://status.worldmonitor.app/" target="_blank" rel="noopener">Status</a>
          ${cleanMode ? '' : `<a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener">GitHub</a>`}
          ${cleanMode ? '' : `<a href="https://discord.gg/re63kWKxaz" target="_blank" rel="noopener">Discord</a>`}
          ${cleanMode ? '' : `<a href="https://x.com/worldmonitorai" target="_blank" rel="noopener">X</a>`}
